...
<div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" data-bs-toggle="modal" data-bs-target="#modal_cart" style="color: red;"><i class="fas fa-shopping-cart"></i><?php $totalcantidad = 2 ?></a>
        </li>
      </ul>
    </div>
...
<div class="card m-4" style="width: 20rem;">
        ...
        <input name="titulo" type="hidden" id="titulo" value="Yogur" />
        <input name="cantidad" type="hidden" id="cantidad" value="1" class="pl-2" />
        <img src="../imagenes/yogur.png" class="card-img-top">
                <div class="card-body">
